...
<body>
    ...
    <img src="assets/images/logo2.jpg" alt="Curlytops Logo" class="navbar-logo">
			...
			<li><a href="customer_order.php"><span class="glyphicon glyphicon-road"></span> Track Order</a></li>
	...
	<div class="one-time">
	    <div><img src="assets/images/intro.jpg"></div>
	    <div><img src="assets/images/intro2.jpg"></div>
	    <div><img src="assets/images/intro3.png"></div>
  	</div>
	<!-- Slider ends -->
